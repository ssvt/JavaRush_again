...
public class Solution {
    ...
    public static void main(String[] args) {
        try {
            ...
            if (cause instanceof FileNotFoundException) System.out.println("Не удалось прочесть файл.");
            else if (cause instanceof FileSystemException) System.out.println("Не удалось записать в файл.");
        }
    }
}
