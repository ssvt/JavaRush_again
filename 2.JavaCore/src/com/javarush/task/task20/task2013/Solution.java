...
public class Solution {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream("d:\\home\\file1.txt"));
        person.writeExternal(outputStream);

        Person p = new Person("1", "2", 2);
        ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream("d:\\home\\file1.txt"));
